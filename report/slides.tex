...
% 阶段标签（汇报逻辑：每页右上角显示当前处于哪一部分）
\newcommand{\phase}{}
% 页眉：标题 + 主题色强调线（简洁一行）
\setbeamertemplate{frametitle}{%
  \vspace{5pt}{\usebeamerfont{frametitle}\insertframetitle}\par\vspace{2pt}%
  {\color{abbred}\rule{0.34\paperwidth}{1.4pt}}\par\vspace{-3pt}}
% 页脚：左=当前阶段（汇报逻辑指示）· 右=署名与页码
\setbeamertemplate{footline}{%
  \hbox{\begin{beamercolorbox}[wd=\paperwidth,ht=2.4ex,dp=1.2ex,leftskip=10pt,rightskip=10pt]{}%
  {\color{abbred}\scriptsize\sffamily\bfseries\phase}\hfill
  {\color{abbgray}\scriptsize abb-offline-coder · 队伍：人工智能创新001\quad\insertframenumber/\inserttotalframenumber}%
  \end{beamercolorbox}}}
...
% ====================================================================
\renewcommand{\phase}{\ding{172} 背景与方案}
% ============ 1. 痛点 ============
...
% ====================================================================
\renewcommand{\phase}{\ding{173} 系统与关键技术}
% ============ 3. 系统设计 ============
...
% ====================================================================
\renewcommand{\phase}{\ding{174} 工程与现场验证}
% ============ 6. 实测与佐证 ============
...
% ====================================================================
\renewcommand{\phase}{\ding{175} 创新与总结}
% ============ 9. 创新点 ============
\begin{frame}{创新点总览}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
