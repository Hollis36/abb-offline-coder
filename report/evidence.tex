...
\midrule
\textbf{合计} & \textbf{4506} & \textbf{37 个 Python 源文件} \\
\bottomrule
\end{tabular}
\end{table}
...
项目自带可离线浏览的展示页（\texttt{docs/index.html}，已部署到 GitHub Pages），
...
\noindent 在线地址：\url{https://hollis36.github.io/abb-offline-coder/}\quad
源码：\url{https://github.com/Hollis36/abb-offline-coder}
