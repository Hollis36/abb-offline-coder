...
| 文件 | 内容 | 规格 |
|------|------|------|
| [`main.tex`](main.tex) / [`main.pdf`](main.pdf) | **项目研究报告**（背景 · 架构 · 关键技术 · 创新点 · 实测 · 实拍配图 · 终端实录；封面含在线演示二维码） | A4 · 21 页 |
...
| [`slides.tex`](slides.tex) / [`slides.pdf`](slides.pdf) | **答辩幻灯**（Beamer 16:9；含真实应用现场照片页 + 尾页在线演示二维码） | 16:9 · 11 页 |
| [`slides_notes.tex`](slides_notes.tex) / [`slides_notes.pdf`](slides_notes.pdf) | **答辩幻灯·演讲者备注版**（每页 幻灯+备注 并排，供 pdfpc/双屏演讲者模式或排练） | 双宽 · 11 页 |
...
| [`combined.tex`](combined.tex) / [`combined.pdf`](combined.pdf) | **合订本**（研究报告 + 佐证材料附录） | A4 · 30 页 |
| [`full_package.tex`](full_package.tex) / [`full_package.pdf`](full_package.pdf) | **全套提交包**（封面 + 总目录 + 书签导航；报告 + 佐证 + 海报 + 幻灯，单文件提交用） | A4/横版/16:9 · 46 页 |
