...
\begin{column}{0.245\textwidth}\centering
  \includegraphics[width=\linewidth]{field-robot.jpg}\\[2pt]{\scriptsize 机器人执行本工具生成程序喷涂}\end{column}
\begin{column}{0.245\textwidth}\centering
...
\end{columns}
\vfill
{\footnotesize 图为本工具生成的 RAPID 喷涂程序在真实（物理隔离、无网）喷涂车间的\textbf{现场运行}与\textbf{成品质检}——\textbf{完全离线}定位真实落地。}
